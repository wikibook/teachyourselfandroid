...
public class QuizSettingsActivity extends QuizActivity {
    ...
    private void initAvatar() {
        ...
        avatarButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
				String strAvatarPrompt = getResources().getString(R.string.take_picture_as_avatar);
        ...
        avatarButton.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
				String strAvatarPrompt = getResources().getString(R.string.choose_picture_as_avatar);
    ...
    private void initDatePicker() {
        ...
        if (mGameSettings.contains(GAME_PREFERENCES_DOB)) {
            ...
            dobInfo.setText(DateFormat.format(dateFormat, mGameSettings.getLong(GAME_PREFERENCES_DOB, 0)));
        } else {
        ...
        case DATE_DIALOG_ID:
			...
			DatePickerDialog dateDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
                ...
                public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
					...
					String dateFormat = getResources().getString(R.string.date_format);
                    dob.setText(DateFormat.format(dateFormat, dtDob));
    ...
    private class ImageUploadTask extends AsyncTask<Object, String, Boolean> {
        ...
        @Override
        protected void onPreExecute() {
            String triviaQuiz = getResources().getString(R.string.trivia_quiz);
            String uploadingAvatar = getResources().getString(R.string.uploading_avatar);

            pleaseWaitDialog = ProgressDialog.show(QuizSettingsActivity.this, triviaQuiz, uploadingAvatar, true, true);
    ...
    private class AccountTask extends AsyncTask<Object, String, Boolean> {
        ...
        protected Boolean doInBackground(Object... params) {
            ...
            if (playerId == -1) {
				...
				// 고유 식별자를 얻는 좋은 방법 중 하나는 기기의 ID이며, 이 정보는 TelephonyManager 데이터에 저장돼 있음
