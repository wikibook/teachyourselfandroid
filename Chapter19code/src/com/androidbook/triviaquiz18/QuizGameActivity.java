...
public class QuizGameActivity extends QuizActivity {
    ...
    private class QuizTask extends AsyncTask<Object, String, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            String downloadingQuestions = getResources().getString(R.string.downloading_questions);

            pleaseWaitDialog = ProgressDialog.show(QuizGameActivity.this, triviaQuiz, downloadingQuestions, true, true);
